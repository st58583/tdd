...
## 6. API Dokumentace (Ukázka REST Endpointu)

Aplikace obsahuje ukázkovou implementaci rozhraní pro vytvoření uživatele. Vrstva validuje vstupy (povinná pole, formát e-mailu) a vrací příslušné HTTP stavové kódy.
